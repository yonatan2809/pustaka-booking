...
<head>
    ...
    <link href="<?= base_url('assets/'); ?>vendor/fontawesome-free/css/all.min.css" rell="stylesheet" type="text/css">
    <link href="<?= base_url('assets/'); ?>datatable/datatables.css" rell="stylesheet" type="text/css">
</head>
<body>
